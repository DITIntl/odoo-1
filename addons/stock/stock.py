...
class stock_move(osv.osv):
    ...
    def _prepare_procurement_from_move(self, cr, uid, move, context=None):
        ...
        return {
            ...
            'group_id': group_id,
            'route_ids': [(4, x.id) for x in move.procurement_id.rule_id.route_id],
    ...
    def _picking_assign(self, cr, uid, move_ids, procurement_group, location_from, location_to, context=None):
        ...
        if context.get('pick_type_id'):
            query += "stock_picking.picking_type_id = %s AND "
            params += (context.get('pick_type_id'),)
    ...
    def action_confirm(self, cr, uid, ids, context=None):
        ...
        for key, move_ids in to_assign.items():
            procurement_group, location_from, location_to, context['pick_type_id'] = key
